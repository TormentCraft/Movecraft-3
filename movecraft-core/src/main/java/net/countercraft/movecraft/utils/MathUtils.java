...
//    public static BlockVec rotateVec(final RotationXZ r, final BlockVec l) {
//        final double theta;
...
//    }
//
    public static double[] rotateVecNoRound(final RotationXZ r, final double x, final double z) {
        final double theta;
        if (r.equals(RotationXZ.cw())) {
            theta = 0.5 * Math.PI;
        } else {
            theta = -1 * 0.5 * Math.PI;
        }
